...
def get_data_training(DRIVE_train_imgs_original='./datasets/drive/hdf5/DRIVE_dataset_imgs_train.hdf5',
                      DRIVE_train_groudTruth='./datasets/drive/hdf5/DRIVE_dataset_groundTruth_train.hdf5',
                      img_size=64,
                      N=2000,
                      inside_FOV=True):
    ...
    patches_imgs_train, patches_masks_train = extract_random(train_imgs,train_masks,patch_height,patch_width,N,inside_FOV)
...
#Load the original data and return the extracted patches for training/testing
def get_data_testing(DRIVE_test_imgs_original='./datasets/drive/hdf5/DRIVE_dataset_imgs_test.hdf5', DRIVE_test_groudTruth='./datasets/drive/hdf5/DRIVE_dataset_groundTruth_test.hdf5', N=20):
    ### test
    ...
    test_imgs = test_imgs[:N,:,36:548,26:538]
    test_masks = test_masks[:N,:,36:548,26:538]
